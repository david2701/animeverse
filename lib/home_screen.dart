...
import 'package:animeverse/test.dart';
...
// Cargar más animes usando el servicio
      ...
      try {
        final newAnimes =
            await animeService.fetchAllAnimes(page: currentPage + 1);
              ...
              IconButton(
               icon: Icon(Icons.telegram_sharp),
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (_) => AnimeFetcherScreen()),
                  );
                },
              ),
              IconButton(
...
// Filtrar animes según la búsqueda
            ...
            return GridView.builder(
              ...
              itemCount: filteredAnimes.length + 1,
              // +1 para el indicador de carga
